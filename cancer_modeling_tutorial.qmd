...
![Cancer natural history model schema](figures/model_schema.png){alt="Cancer natural history model schema"}
...
@@@ TO DO: Update target plots, make numbers more consistent
@@@ TODO: Check BayCANN: check if STAN priors are actually uniform
@@ journal ideas

#### Run algorithm

\[External step\] 
1. Run analysis/run_IMABC.R
