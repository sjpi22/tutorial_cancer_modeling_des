...
# Calculate calibration outputs
l_prior_targets <- calc_calib_targets(results_noscreening_max)
```
...
External step: Run analysis/run_IMABC.R
...
Plot parameters: IMABC distribution in gray, true parameters in red, uniform range of priors in blue
...
External step: Run analysis/run_BayCANN.R (which must be run after analysis/generate_BayCANN_sample.R)
